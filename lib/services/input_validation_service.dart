...
class InputValidationService {
  ...
  static ValidationResult validateWaterIntake(int glasses) {
    ...
    if (glasses > 20) {
      return const ValidationResult(
        isValid: true,
        warningMessage:
            'That\'s a lot of water! Make sure you\'re not overhydrating',
  ...
  static ValidationResult validateCalories(int calories) {
    ...
    if (calories > 5000) {
      return const ValidationResult(
        ...
        suggestion:
            'Consider consulting a nutritionist if this is your daily intake',
      );
    }
  ...
  static ValidationResult validateSleepHours(double hours) {
    ...
    if (hours > 12) {
      return const ValidationResult(
        ...
        suggestion:
            'Consider consulting a doctor if you sleep this much regularly',
      );
    }
  ...
  static void showValidationResult(
      BuildContext context, ValidationResult result) {
    if (!result.isValid) {
