...
class GlobalGoogleFitManager {
  static final GlobalGoogleFitManager _instance = GlobalGoogleFitManager._internal();
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      if (_isConnected) {
        ...
        print('⚠️ GlobalGoogleFitManager: Not connected - Will check periodically');
        _startConnectionCheck();
      }
  ...
  void _startAutoSync() {
    ...
    print('🔄 GlobalGoogleFitManager: Auto-sync started (${_autoSyncInterval.inMinutes}m intervals)');
  }
  ...
  void _startConnectionCheck() {
    ...
    print('🔍 GlobalGoogleFitManager: Connection check started (${_connectionCheckInterval.inMinutes}m intervals)');
  }
  ...
  Future<void> _checkConnection() async {
    try {
      ...
      _isConnected = await _googleFitService.validateAuthentication()
          .timeout(const Duration(seconds: 5));
  ...
  void _performSync() {
    ...
    _cacheService.forceRefresh().then((data) {
      if (data != null) {
        ...
        print('🔄 GlobalGoogleFitManager: Auto-sync completed - Steps: ${data.steps}');
      }
    }).catchError((e) {
