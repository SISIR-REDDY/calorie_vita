...
class AppTheme {
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        brightness: Brightness.dark,
        scaffoldBackgroundColor: kDarkAppBackground,
        cardTheme: CardThemeData(
        ...
        outlinedButtonTheme: OutlinedButtonThemeData(
          style: OutlinedButton.styleFrom(
            ...
            side: const BorderSide(color: kPrimaryLight, width: 1.5),
            elevation: 0,
            padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 16),
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(12),
        ...
        inputDecorationTheme: InputDecorationTheme(
          filled: true,
          fillColor: kDarkSurfaceLight,
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: const BorderSide(color: kDarkBorderColor, width: 1),
          ),
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: const BorderSide(color: kDarkBorderColor, width: 1),
        ...
        bottomNavigationBarTheme: const BottomNavigationBarThemeData(
          backgroundColor: kDarkSurfaceLight,
          selectedItemColor: kPrimaryLight,
          unselectedItemColor: kDarkTextTertiary,
          type: BottomNavigationBarType.fixed,
          elevation: 8,
        ),
      );
